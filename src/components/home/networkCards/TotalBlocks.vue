  ...
  <button class="network-card">
    <div class="network-card-wrapper">
      <div class="icon-field">
        <div class="icon-base">
          <img src="@/assets/images/icons/cubes.svg" alt="" />
        </div>
      </div>
      <div class="content-field">
        <p class="data-text">{{ Number(blockList).toLocaleString() }}</p>
...
export default {
  ...
  setup() {
    ...
    return { showIcon, titleText, blockList, loading, error };
  },
};
</script>
